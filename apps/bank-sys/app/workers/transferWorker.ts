...
// console.log('📦 Attempting to import prisma_Bank...');

// try {
//   const testImport = require('@repo/db_banks/prisma_client');
//   console.log('✅ Import successful, type:', typeof testImport);
//   console.log('🔑 Available keys:', Object.keys(testImport));
//   console.log('🗄️  Default export:', testImport.default ? 'EXISTS' : 'MISSING');
// } catch (err:any) {
