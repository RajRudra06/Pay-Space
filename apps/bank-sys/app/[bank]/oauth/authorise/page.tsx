...
export default function AuthorizePage() {
  ...
  async function sendOTP() {
    try {
      ...
      const responseOTP = await axios.post(`${API_URL}/bank/oauth/token`, {
        client_id: clientID,
    ...
    if(status.state==='verified'){
      try {
        ...
        if(sendOTP.data.done){
          ...
          window.location.href = `${redirect_uri}?code=${tempCode}`;
...
//     try{
//         const responseOTP = await axios.post(`http://localhost:3002/api/bank/oauth/token`,{client_id:clientID,user_email:userEmail},{headers: {
//           "Content-Type": "application/json",
//         }}); 
...
//         else{
//           setMessage(responseOTP.data.msg)
//           return false;
//         }
//     }
//     catch{
...
//   // Your existing handleAllow function integrated with OTP verification
//   const handleAllow = () => {
...
//     // Simulate OTP verification first
//     setTimeout(() => {
//       try {
//         // Your existing logic - be call to bank api to get code and check client_id and send code here and setCode
//         const tempCode = '1234';
//         window.location.href = `${redirectURL}?code=${tempCode}`;
//       } catch (error) {
//         console.error('Error during authorization:', error);
//         setIsVerifying(false);
//       }
...
//               <h4 className="font-medium text-gray-900 mb-1">Secure Authorization</h4>
//               <p className="text-sm text-gray-600">
//                 This OTP is valid for 10 minutes and will authorize access to your {bankName} account data.
//               </p>
//             </div>
//           </div>
//         </div>
...
//     </div>
//   </div>
// ) : isValid?<>     <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 flex items-center justify-center p-4">
// <div className="w-full max-w-md">
//   {/* Header */}
//   <div className="text-center mb-8">
//     <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${currentTheme.gradient} rounded-full mb-6 shadow-lg`}>
...
// </div>
// </>:(
//   <Loading message='Loading...' subMessage='Verifying details...' isVisible={!isVerified}/>
// )}
...
//     try {
//         // be call to bank api to get code and check client_id and send code here and setCode
